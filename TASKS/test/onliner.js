describe('onliner homepage', function (){
	...
	var filterApple=element(by.xpath('//*[@id="schema-filter"]/div[1]/div[3]/div[2]/ul/li[4]/label/span[1]/span'));
	var filtrYear2016=element(by.xpath('//*[@id="schema-filter"]/div[1]/div[6]/div[3]/ul/li[2]/label/span[1]/span'));	
	var filtrYear2015=element(by.xpath('//*[@id="schema-filter"]/div/div[6]/div[3]/ul/li[3]/label/span/span'));	
